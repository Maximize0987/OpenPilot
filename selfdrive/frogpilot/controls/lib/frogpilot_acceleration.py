...
A_CRUISE_MAX_VALS_ECO =        [3.3, 2.8, 2.4, 1.8, 1.3, 1.0, 0.8]    # old = [2.0, 1.5, 1.0, 0.8, 0.6, 0.4, 0.2]
A_CRUISE_MAX_VALS_SPORT =      [3.8, 3.3, 2.8, 2.0, 1.3, 1.0, 0.8]    # old = [3.0, 2.5, 2.0, 1.5, 1.0, 0.8, 0.6]
